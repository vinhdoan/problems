...
-file("./exp_lexer.xrl", 11).
yyaction_0(TokenChars, TokenLine) ->
     { token, { divi, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("./exp_lexer.xrl", 12).
yyaction_1(TokenChars, TokenLine) ->
     { token, { add, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("./exp_lexer.xrl", 13).
yyaction_2(TokenChars, TokenLine) ->
     { token, { sub, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_3/2}).
-file("./exp_lexer.xrl", 14).
yyaction_3(TokenChars, TokenLine) ->
     { token, { mul, TokenLine, list_to_atom (TokenChars) } } .

-compile({inline,yyaction_4/2}).
-file("./exp_lexer.xrl", 15).
yyaction_4(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_5/2}).
-file("./exp_lexer.xrl", 16).
yyaction_5(TokenChars, TokenLine) ->
     { token, { float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_6/2}).
-file("./exp_lexer.xrl", 17).
yyaction_6(TokenChars, TokenLine) ->
     { token, { list_to_atom (TokenChars), TokenLine } } .

-compile({inline,yyaction_7/0}).
-file("./exp_lexer.xrl", 18).
yyaction_7() ->
     skip_token .
